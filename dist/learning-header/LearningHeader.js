      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("/os-api/api/status/".concat(course_id, "/").concat(authenticatedUser.username));
          case 3:
...
var LearningHeader = function LearningHeader(_ref3) {
  var courseOrg = _ref3.courseOrg,
    courseNumber = _ref3.courseNumber,
    courseTitle = _ref3.courseTitle,
    intl = _ref3.intl,
